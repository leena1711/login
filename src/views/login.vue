    ...
    <div class="hero-content flex-col lg:flex-row">
      <div class="lg:card text-center lg:text-left">
        ...
        <div v-if="loginMode" class="lg:card-body lg:max-w-md">
          ...
          <p class="py-6 w-full lg:text-lg">Welcome back! Please sign in to access your account</p>
        </div>
        <div v-else class="lg:card-body lg:max-w-md">
          <h1 class="text-5xl font-bold">Register</h1>
          <p class="py-6 w-full lg:text-lg">Sign up now to unlock exclusive benefits and join our vibrant community!</p>
        </div>
      </div>
      <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
        ...
        <form v-if="loginMode" class="card-body" @submit.prevent="login">
          <div class="form-control">
            ...
            <input v-model="loginEmail" type="username" placeholder="Username" class="input input-bordered" required />
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Password</span>
            </label>
            <input v-model="loginPassword" type="password" placeholder="Password" class="input input-bordered" required />
            <label class="label">
          ...
          <div class="flex flex-col text-center">
            ...
            <p>Don't have an account? <a @click.prevent="toggleMode" class="cursor-pointer hover:underline">Sign up</a></p>
          </div>
        </form>
        <!-- Registration form -->
        <form v-else class="card-body" @submit.prevent="register">
          <div class="form-control">
            ...
            <input v-model="registerEmail" type="username" placeholder="Email" class="input input-bordered" required />
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Password</span>
            </label>
            <input v-model="registerPassword" type="password" placeholder="Password" class="input input-bordered" required />
          </div>
          <div class="mt-6">
          ...
          <div class="flex flex-col text-center">
            ...
            <p>Already have an account? <a @click.prevent="toggleMode" class="cursor-pointer hover:underline">Sign in</a></p>
          </div>
        </form>
      </div>
    </div>
